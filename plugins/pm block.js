...
var plk = ''
var plk2 = ''
if (Config.LANG == 'EN') plk = 'chatting in pm is not allowed'
if (Config.LANG == 'EN') plk2 = '.block'
if (Config.LANG == 'ML') plk = 'PM ൽ ചാറ്റിംഗ് അനുവദനീയമല്ല'
if (Config.LANG == 'ML') plk2 = '.block'
rdxbot.addCommand({on: 'text', fromMe: false, onlyPm: true , deleteCommand: false}, (async (message, match) => {
    if (pmblock_var == 'true' && message.jid !== '917736771516@s.whatsapp.net') {
        let regex1 = anything
